...
//    }
    ...
    private BlackIndex buildIndex(TBlack black) {
        return BlackIndex.builder()
                .cid(black.getCid())
                .creditNo(black.getCreditNo())
                .memberName(black.getMemberName())
                .reasonCode(black.getReasonCode())
                .addTime(black.getAddTime())
                .updateTime(black.getUpdateTime())
                .channel(black.getChannel())
                .mobilePhone(black.getMobilePhone())

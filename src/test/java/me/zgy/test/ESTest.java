...
public class ESTest extends BaseTest {
    ...
    public void query() throws IOException {
        ...
        List<SearchResult.Hit<UserInfoDto, Void>> hits = result.getHits(UserInfoDto.class);
        ESSearchResult<UserInfoDto> esSearchResult = ESHandler.parseResult(result, UserInfoDto.class);
    }
